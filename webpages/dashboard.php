    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
                        <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="#">EZaudit Dashboard</a>
            <!-- Navbar Search-->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">On-going Audit</div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">On-hold Audit</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Completed Audit</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Failed Audit</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Construction Form EZ-C01 Data Table
                            </div>
                            <div class="card-body">
                                        ...
                                        <?php 
                                            ...
                                            if ($data) {
                                                foreach ($data as $row) {
                                                    ...
                                                    echo "<td>" . htmlspecialchars($row['aulocation']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($row['date_of_audit']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($row['prepared_by']) . "</td>";
                                                    echo "<td>";
                                                        echo "<a href='dashboard_read.php?id=" . urlencode($row['id']) . "' class='details-button'>Details</a>";
                                                        echo "<a href='dashboard_update.php?id=" . urlencode($row['id']) . "' class='details-button'>Update</a>";
                                                        echo "<a href='../backend/delete.php?id=" . urlencode($row['id']) . "' class='delete-button' onclick=\"return confirm('Are you sure you want to delete this item?')\">DELETE</a>";
